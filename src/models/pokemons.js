module.exports = (sequelize, DataTypes) => {
  const validTypes = ['feu','eau','terre','air','foudre','soleil','son','espace','neos','plante','poison','electrik','vol','insecte','fée','normal']
          ...
          isTypeValid(value){
            ...
            Va.forEach(typ => {
              if(!validTypes.includes(typ.toLowerCase())){
                throw new Error(`Vos types doivent etre parmis ceux ci ${validTypes}`)
              }
            })
          }
        }
